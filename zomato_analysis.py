...
areas = {
    'Bangalore': ['Koramangala', 'Indiranagar', 'Whitefield', 'HSR Layout', 'BTM Layout'],
    'Mumbai': ['Bandra', 'Andheri', 'Juhu', 'Powai', 'Colaba'],
    'Delhi': ['Connaught Place', 'Lajpat Nagar', 'Karol Bagh', 'Saket', 'Dwarka'],
    'Hyderabad': ['Banjara Hills', 'Jubilee Hills', 'Hitech City', 'Gachibowli'],
    'Chennai': ['Anna Nagar', 'T Nagar', 'Velachery', 'Adyar', 'OMR'],
    'Pune': ['Koregaon Park', 'Baner', 'Hinjewadi', 'Kothrud'],
    'Kolkata': ['Park Street', 'Salt Lake', 'New Town', 'Gariahat'],
    'Ahmedabad': ['SG Highway', 'CG Road', 'Navrangpura'],
    'Jaipur': ['MI Road', 'Vaishali Nagar', 'C Scheme'],
...
rest_names = [
    ...
    'The Hungry Tiger', 'Kebab King', 'Sweet Tooth', 'Noodle Box', 'Dhaba Express',
    'Chaat Junction', 'Grill House', 'Tiffin Box', 'Momo Point', 'Fusion Bites',
    'Classic Dining', 'Urban Kitchen', 'Flavor Town', 'Aroma Restaurant', 'Cloud Kitchen'
]
